...
// A ControllerConfig applies settings to controllers like
// Provider pods.
// Deprecated: Use the
...
// Read the
// [Package Runtime
// Configuration](https://github.com/crossplane/crossplane/blob/11bbe13ea3604928cc4e24e8d0d18f3f5f7e847c/design/one-pager-package-runtime-config.md)
...
#ControllerConfig: {
	...
	// ControllerConfigSpec specifies the configuration for a packaged
	// controller.
...
#ControllerConfigSpec: {
	...
	// Setting ImagePullSecrets will replace any secrets that have
	// been
	// propagated to a controller Deployment, typically via
	// packagePullSecrets.
	imagePullSecrets?: [...{
		// Name of the referent.
		// This field is effectively required, but due to backwards
	...
	// Note: If more than 1 replica is set and leader election is not
	// enabled then
	// controllers could conflict. Environment variable
	// "LEADER_ELECTION" can be
	...
	// More info:
	// https://github.com/kubernetes/enhancements/blob/master/keps/sig-node/585-runtime-class/README.md
	// This is a beta feature as of Kubernetes v1.14.
	runtimeClassName?: string

	// SecurityContext holds container-level security attributes and
	// common container settings.
	// Optional: Defaults to empty. See type description for default
	// values of each field.
	securityContext?: {
	...
	// will be used for
	// the spec.serviceAccountName field in Pods to be created and for
	// the subjects.name field
	// in a ClusterRoleBinding to be created.
	// If there is no ServiceAccount named this ServiceAccountName, a
	// new ServiceAccount
	// will be created.
	// If there is a pre-existing ServiceAccount named this
	// ServiceAccountName, the ServiceAccount
	// will be used. The annotations in the ControllerConfig will be
	// copied to the ServiceAccount
	// and pre-existing annotations will be kept.
	// Regardless of whether there is a ServiceAccount created by
	// Crossplane or is in place already,
	// the ServiceAccount will be deleted once the Provider and
	// ControllerConfig are deleted.
